    ...
    <x-card class="space-y-4">
        <div class="flex items-start justify-between gap-3">
            <div>
                ...
                <div class="mt-1 text-sm text-[var(--color-text-muted)]">Lihat semua dokumen PO/PR.</div>
            </div>
    ...
    @else
        <div class="space-y-3 md:hidden">
            @foreach ($documents as $doc)
                <a href="{{ route('admin.documents.show', $doc) }}" class="block">
                ...
                <tbody class="divide-y divide-[var(--color-border)] bg-white">
                    @foreach ($documents as $doc)
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <a
                                    href="{{ route('admin.documents.show', $doc) }}"
