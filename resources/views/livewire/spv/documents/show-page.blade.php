<div class="space-y-4">
    <x-card class="space-y-3">
        <div class="flex items-start justify-between gap-3">
            <div>
                ...
                <div class="mt-1 text-sm text-[var(--color-text-muted)]">Review hasil Warehouse.</div>
            </div>
        ...
        @foreach ($items as $item)
            <x-card class="space-y-2">
                ...
                @if ($canReject || $canApprove)
                    <div class="mt-2">
                        <label class="block text-sm font-medium text-[var(--color-text-main)]">Catatan SPV (opsional)</label>
                        <textarea
                            ...
                            placeholder="Contoh: mohon cek qty / foto kurang jelas / dll"
                        ></textarea>
                    </div>
                @endif
            </x-card>
    ...
    <x-modal :show="$showApproveModal" title="Approve Dokumen?">
        <div class="space-y-4">
            <div class="text-sm text-[var(--color-text-muted)]">
                Pastikan semua item sudah <span class="font-semibold text-[var(--color-text-main)]">Sesuai</span> dan foto lengkap.
            </div>
    ...
    <x-modal :show="$showRejectModal" title="Reject Dokumen?">
        <div class="space-y-4">
            <div class="text-sm text-[var(--color-text-muted)]">
                Dokumen akan dikembalikan ke Warehouse.
            </div>
            <div class="space-y-2">
